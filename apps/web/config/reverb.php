...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Laravel may publish to an internal Reverb hostname while desktop clients
    | connect through a public hostname and port.
    |
    */
    ...
    'broadcast_max_payload_size' => (int) env('REVERB_BROADCAST_MAX_PAYLOAD_SIZE', 8_000),
